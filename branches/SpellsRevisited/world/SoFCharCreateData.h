...
static struct SoFCCData SoFCharCreateInfo = {
	...
	{     //  ?    ?    ?    ?   Race Cls Deity  ?  Zone
              ...
              {   4,   0,   0,   0, 130,   1, 396,  80, 155 },  // Vah Shir/Warrior/Agnostic/sharvahl
              {   4,   8,   0,   0, 130,   8, 396,  75, 394 },  // Vah Shir/Bard/Agnostic/crescent
              {   4,   0,   0,   0, 130,   8, 396,  75, 155 },  // Vah Shir/Bard/Agnostic/sharvahl
              {   4,   8,   0,   0, 130,   9, 396,  78, 394 },  // Vah Shir/Rogue/Agnostic/crescent
              {   4,   0,   0,   0, 130,   9, 396,  78, 155 },  // Vah Shir/Rogue/Agnostic/sharvahl
              {   4,   8,   0,   0, 130,  10, 396,  79, 394 },  // Vah Shir/Shaman/Agnostic/crescent
              {   4,   0,   0,   0, 130,  10, 396,  79, 155 },  // Vah Shir/Shaman/Agnostic/sharvahl
              {   4,   8,   0,   0, 130,  15, 396,  76, 394 },  // Vah Shir/Beastlord/Agnostic/crescent
              {   4,   0,   0,   0, 130,  15, 396,  76, 155 },  // Vah Shir/Beastlord/Agnostic/sharvahl
              {  68,   8,   0,   0, 130,  16, 396,  77, 394 },  // Vah Shir/Berzerker/Agnostic/crescent
              {  68,   0,   0,   0, 130,  16, 396,  77, 155 },  // Vah Shir/Berzerker/Agnostic/sharvahl
              {  16,   8,   0,   0, 330,   1, 208,  92, 394 },  // Froglok/Warrior/Mithaniel Marr/crescent
              {  16,   0,   0,   0, 330,   1, 208,  92,  50 },  // Froglok/Warrior/Mithaniel Marr/rathemtn
              ...
              {  16,   0,   0,   0, 330,   2, 206,  86,  50 },  // Froglok/Cleric/Innoruuk/rathemtn
              {  16,   0,   0,   0, 330,   2, 208,  86,  50 },  // Froglok/Cleric/Mithaniel Marr/rathemtn
              {  16,   8,   0,   0, 330,   3, 208,  88, 394 },  // Froglok/Paladin/Mithaniel Marr/crescent
              {  16,   0,   0,   0, 330,   3, 208,  88,  50 },  // Froglok/Paladin/Mithaniel Marr/rathemtn
              {  16,   8,   0,   0, 330,   5, 206,  90, 394 },  // Froglok/SK/Innoruuk/crescent
              {  16,   0,   0,   0, 330,   5, 206,  90,  50 },  // Froglok/SK/Innoruuk/rathemtn
              {  16,   8,   0,   0, 330,   9, 206,  89, 394 },  // Froglok/Rogue/Innoruuk/crescent
              {  16,   0,   0,   0, 330,   9, 206,  89,  50 },  // Froglok/Rogue/Innoruuk/rathemtn
              {  16,   8,   0,   0, 330,  10, 208,  91, 394 },  // Froglok/Shaman/Mithaniel Marr/crescent
              {  16,   0,   0,   0, 330,  10, 208,  91,  50 },  // Froglok/Shaman/Mithaniel Marr/rathemtn
              {  16,   8,   0,   0, 330,  11, 206,  87, 394 },  // Froglok/Necro/Innoruuk/crescent
              {  16,   0,   0,   0, 330,  11, 206,  87,  50 },  // Froglok/Necro/Innoruuk/rathemtn
              {  16,   8,   0,   0, 330,  12, 208,  93, 394 },  // Froglok/Wizard/Mithaniel Marr/crescent
              {  16,   0,   0,   0, 330,  12, 208,  93,  50 },  // Froglok/Wizard/Mithaniel Marr/rathemtn
