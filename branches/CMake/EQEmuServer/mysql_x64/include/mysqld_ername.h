...
{ "ER_COL_COUNT_DOESNT_MATCH_CORRUPTED_V2", 1701, "Column count of %s.%s is wrong. Expected %d, found %d. The table is probably corrupted" },
{ "ER_CANNOT_LOAD_FROM_TABLE_V2", 1702, "Cannot load from %s.%s. The table is probably corrupted" },
{ "ER_MASTER_DELAY_VALUE_OUT_OF_RANGE", 1703, "The requested value %u for the master delay exceeds the maximum %u" },
{ "ER_ONLY_FD_AND_RBR_EVENTS_ALLOWED_IN_BINLOG_STATEMENT", 1704, "Only Format_description_log_event and row events are allowed in BINLOG statements (but %s was provided)" },
{ "ER_PARTITION_EXCHANGE_DIFFERENT_OPTION", 1705, "Non matching attribute \'%-.64s\' between partition and table" },
{ "ER_PARTITION_EXCHANGE_PART_TABLE", 1706, "Table to exchange with partition is partitioned: \'%-.64s\'" },
{ "ER_PARTITION_EXCHANGE_TEMP_TABLE", 1707, "Table to exchange with partition is temporary: \'%-.64s\'" },
{ "ER_PARTITION_INSTEAD_OF_SUBPARTITION", 1708, "Subpartitioned table, use subpartition instead of partition" },
{ "ER_UNKNOWN_PARTITION", 1709, "Unknown partition \'%-.64s\' in table \'%-.64s\'" },
{ "ER_TABLES_DIFFERENT_METADATA", 1710, "Tables have different definitions" },
{ "ER_ROW_DOES_NOT_MATCH_PARTITION", 1711, "Found a row that does not match the partition" },
{ "ER_BINLOG_CACHE_SIZE_GREATER_THAN_MAX", 1712, "Option binlog_cache_size (%lu) is greater than max_binlog_cache_size (%lu); setting binlog_cache_size equal to max_binlog_cache_size." },
{ "ER_WARN_INDEX_NOT_APPLICABLE", 1713, "Cannot use %-.64s access on index \'%-.64s\' due to type or collation conversion on field \'%-.64s\'" },
{ "ER_TRUNCATE_ILLEGAL_FK", 1714, "Cannot truncate a table referenced in a foreign key constraint (%.192s)" },
{ "ER_PLUGIN_IS_PERMANENT", 1715, "Plugin \'%s\' is force_plus_permanent and can not be unloaded" },
{ "ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MIN", 1716, "The requested value for the heartbeat period is less than 1 millisecond. The value is reset to 0, meaning that heartbeating will effectively be disabled." },
{ "ER_SLAVE_HEARTBEAT_VALUE_OUT_OF_RANGE_MAX", 1717, "The requested value for the heartbeat period exceeds the value of `slave_net_timeout\' seconds. A sensible value for the period should be less than the timeout." },
{ "ER_PARTITION_EXCHANGE_FOREIGN_KEY", 1718, "Table to exchange with partition has foreign key references: \'%-.64s\'" },
{ "ER_NO_SUCH_KEY_VALUE", 1719, "Key value \'%-.192s\' was not found in table \'%-.192s.%-.192s\'" },
{ "ER_RPL_INFO_DATA_TOO_LONG", 1720, "Data for column \'%s\' too long" },
{ "ER_CANT_LOCK_RPL_INFO_TABLE", 1721, "You can\'t use locks with rpl info tables." },
{ "ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE", 1722, "Replication event checksum verification failed while reading from network." },
{ "ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE", 1723, "Replication event checksum verification failed while reading from a log file." },
{ "ER_STMT_CACHE_FULL", 1724, "Multi-row statements required more than \'max_binlog_stmt_cache_size\' bytes of storage; increase this mysqld variable and try again" },
{ "ER_MULTI_UPDATE_KEY_CONFLICT", 1725, "Primary key/partition key update is not allowed since the table is updated both as \'%-.192s\' and \'%-.192s\'." },
{ "ER_BINLOG_STMT_CACHE_SIZE_GREATER_THAN_MAX", 1726, "Option binlog_stmt_cache_size (%lu) is greater than max_binlog_stmt_cache_size (%lu); setting binlog_stmt_cache_size equal to max_binlog_stmt_cache_size." },
{ "ER_CANT_UPDATE_TABLE_IN_CREATE_TABLE_SELECT", 1727, "Can\'t update table \'%-.192s\' while \'%-.192s\' is being created." },
{ "ER_PARTITION_CLAUSE_ON_NONPARTITIONED", 1728, "PARTITION () clause on non partitioned table" },
{ "ER_ROW_DOES_NOT_MATCH_GIVEN_PARTITION_SET", 1729, "Found a row not matching the given partition set" },
{ "ER_NO_SUCH_PARTITION", 1730, "partition \'%-.64s\' doesn\'t exist" },
{ "ER_TABLE_NEEDS_REBUILD", 1731, "Table rebuild required. Please do \"ALTER TABLE `%-.32s` FORCE\" or dump/reload to fix it!" },
{ "WARN_OPTION_BELOW_LIMIT", 1732, "The value of \'%s\' should be no less than the value of \'%s\'" },
{ "ER_CHANGE_RPL_INFO_REPOSITORY_FAILURE", 1733, "Failure while changing the type of replication repository: %s." },
{ "ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_CREATED_TEMP_TABLE", 1734, "The creation of some temporary tables could not be rolled back." },
{ "ER_WARNING_NOT_COMPLETE_ROLLBACK_WITH_DROPPED_TEMP_TABLE", 1735, "Some temporary tables were dropped, but these operations could not be rolled back." },
{ "ER_INDEX_COLUMN_TOO_LONG", 1736, "Index column size too large. The maximum column size is %lu bytes." },
{ "ER_ERROR_IN_TRIGGER_BODY", 1737, "Trigger \'%-.64s\' has an error in its body: \'%-.256s\'" },
{ "ER_ERROR_IN_UNKNOWN_TRIGGER_BODY", 1738, "Unknown trigger has an error in its body: \'%-.256s\'" },
{ "ER_INDEX_CORRUPT", 1739, "Index %s is corrupted" },
{ "ER_MTS_FEATURE_IS_NOT_SUPPORTED", 1740, "%s is not supported in multi-threaded slave mode. %s" },
{ "ER_MTS_UPDATED_DBS_GREATER_MAX", 1741, "The number of modified databases exceeds the maximum %d; the database names will not be included in the replication event metadata." },
{ "ER_MTS_CANT_PARALLEL", 1742, "Cannot execute the current event group in the parallel mode. Encountered event %s, relay-log name %s, position %s which prevents execution of this event group in parallel mode. Reason: %s." },
{ "ER_MTS_INCONSISTENT_DATA", 1743, "%s" },
