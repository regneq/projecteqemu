...
(844, 'Advanced Theft of Life', 5, 2, 31455, 31456, 31453, 31454, 6, 0, 634, 3, 0, 0, 2080, 0, 65, 0);

INSERT INTO altadv_vars (skill_id, name, cost, max_level, hotkey_sid, hotkey_sid2, title_sid, desc_sid, type, spellid, prereq_skill, prereq_minpoints, spell_type, spell_refresh, classes, berserker, class_type, cost_inc) VALUES
(1319, 'Soul Thief', 5, 3, 31459, 31460, 31457, 31458, 7, 0, 844, 2, 0, 0, 2080, 0, 68, 0);

INSERT INTO altadv_vars (skill_id, name, cost, max_level, hotkey_sid, hotkey_sid2, title_sid, desc_sid, type, spellid, prereq_skill, prereq_minpoints, spell_type, spell_refresh, classes, berserker, class_type, cost_inc) VALUES
(209, 'Death Peace', 5, 1, 13738, 13739, 13736, 13737, 6, 0, 0, 0, 0, 5, 2080, 0, 65, 0);

INSERT INTO altadv_vars (skill_id, name, cost, max_level, hotkey_sid, hotkey_sid2, title_sid, desc_sid, type, spellid, prereq_skill, prereq_minpoints, spell_type, spell_refresh, classes, berserker, class_type, cost_inc) VALUES
(1134, 'Blur of Axes', 3, 3, 31463, 31464, 31461, 31462, 5, 0, 0, 0, 0, 0, 0, 1, 61, 1); 

INSERT INTO altadv_vars (skill_id, name, cost, max_level, hotkey_sid, hotkey_sid2, title_sid, desc_sid, type, spellid, prereq_skill, prereq_minpoints, spell_type, spell_refresh, classes, berserker, class_type, cost_inc) VALUES
(1158, 'Vicious Frenzy', 4, 5, 31467, 31468, 31465, 31466, 7, 0, 1134, 3, 0, 0, 0, 1, 67, 0);
