...
//	uint8	flag[60];		//this is for quests or something...
	...
	bool SpellFinished(uint16 spell_id, Mob *target, bool isproc = false, uint16 slot = 10, uint16 mana_used = 0, uint32 inventory_slot = 0xFFFFFFFF, int16 resist_adjust = 0);
	virtual bool SpellOnTarget(uint16 spell_id, Mob* spelltar, bool isproc = false, bool reflect = false, bool use_resist_adjust = false, int16 resist_adjust = 0);
