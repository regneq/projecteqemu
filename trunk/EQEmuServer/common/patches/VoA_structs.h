#ifndef VoA_STRUCTS_H_
#define VoA_STRUCTS_H_
...
/*0004*/ //	int16	total_chars;	//total number of chars allowed?
/*0008*/ //	uint8	unknown8;
...
struct Spawn_Struct_Bitfields
{
	...
	//
	unsigned   linkdead:1;			// 1	Toggles LD on or off after name. Correct for VoA
	...
	unsigned   trader:1;			// 0	Unk in VoA
	unsigned   buyer:1;			// 0	Unk in VoA
};
...
static const uint32 MAX_PP_MEMSPELL		= 12; //was 9 now 10 on Live
...
/*13076*/ uint32  aapoints_spent;			// Number of spent AA points
/*13080*/ uint32  aapoints_assigned;		// Number of Assigned AA points
/*13084*/ uint8   unknown13084[16];			// 
...
/*014*/ int32 unknown19; // New to VoA
...
/*0076*/ uint8	unknown0076[4]; // New for VoA
...
struct ItemQuaternaryBodyStruct
{
	...
	uint32 unknown26;
	uint32 unknown27;
	uint8 unknown_voa5;		// 0 New to March 21 2012 client
