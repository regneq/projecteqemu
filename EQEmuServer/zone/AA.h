...
typedef enum {	//AA IDs
	...
	aaEternalBreath = 978,
	aaBlacksmithingMastery = 979,
	aaBakingMastery = 982,
	aaBrewingMastery = 985,
	aaFletchingMastery2 = 988,	//whats the difference?
	aaPotteryMastery = 991,
	aaTailoringMastery = 994,
	aaSalvage = 997,
	aaOrigin = 1000,
	aaChaoticPotential = 1001,
	aaDiscordantDefiance = 1006,
	aaTrialsofMataMuram = 1011,
	aaMysticalAttuning = 1021,
	aaDelayDeath = 1026,
	aaHealthyAura = 1031,
	aaFitness = 1036,
	aaVeteransWrath = 1041,
