...
public:
    ...
    virtual void EventPlayer(QuestEventID evt, Client *client, std::string data, uint32 extra_data, bool player_global = false) { }
	...
	virtual bool PlayerHasQuestSubGlobal(const char *subname) { return false; }
